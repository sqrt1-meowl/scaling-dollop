...
const set1 = {
  ...
  reading: [
    ...
    read("Read a Short Informational Passage", "Zero-Trust Security",
      "Traditional computer security often treated everyone inside an organization's network as trustworthy. Zero-trust security assumes instead that no user or device should receive automatic access. Each request is verified, and access is limited to the information needed for a particular task. The model cannot prevent every attack, but it can reduce the damage caused by a stolen password because one account does not automatically unlock the entire system. It also requires repeated monitoring, since a user who was verified earlier may later show suspicious behavior.", [
