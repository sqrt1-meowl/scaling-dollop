...
const content: Record<GeometryLevelCode, PreviewContent> = {
  G1U1: {
    ...
    problems: [
      { id: "g1u1-e1", band: "EASY", stem: "A triangle has base 14 and height 9. What is its area?", choices: ["23", "63", "126", "252"], answerFormat: "MC" },
  ...
  G1U2: {
    ...
    problems: [
      { id: "g1u2-e1", band: "EASY", stem: "A rectangular prism is 5 units by 4 units by 9 units. What is its volume?", choices: ["18", "90", "160", "180"], answerFormat: "MC" },
  ...
  G1U3: {
    ...
    problems: [
      ...
      { id: "g1u3-m1", band: "MEDIUM", stem: "Corresponding lengths of two similar figures are in the ratio 2:5. What is the ratio of their areas?", choices: ["2:5", "4:10", "4:25", "8:125"], answerFormat: "MC" },
  ...
  G2U1: {
    ...
    problems: [
      { id: "g2u1-e1", band: "EASY", stem: "Two lines intersect. One angle measures 47°. What is the measure of its vertical angle?", choices: ["43°", "47°", "133°", "180°"], answerFormat: "MC" },
  ...
  G2U2: {
    ...
    problems: [
      { id: "g2u2-e1", band: "EASY", stem: "An isosceles triangle has a vertex angle of 40°. What is the measure of each base angle?", choices: ["40°", "60°", "70°", "140°"], answerFormat: "MC" },
  ...
  G2U3: {
    ...
    problems: [
      ...
      { id: "g2u3-e2", band: "EASY", stem: "A side of length 9 in one triangle corresponds to a side of length 15 in a similar triangle. A side of length 12 corresponds to what length?", choices: ["16", "18", "20", "24"], answerFormat: "MC" },
  ...
  G3U1: {
    ...
    problems: [
      { id: "g3u1-e1", band: "EASY", stem: "A right triangle has legs 5 and 12. What is its hypotenuse?", choices: ["7", "13", "17", "25"], answerFormat: "MC" },
  ...
  G3U2: {
    ...
    problems: [
      { id: "g3u2-e1", band: "EASY", stem: "In a right triangle, the side opposite θ is 5 and the hypotenuse is 13. What is sin θ?", choices: ["5/13", "12/13", "5/12", "13/5"], answerFormat: "MC" },
  ...
  G4U1: {
    ...
    problems: [
      { id: "g4u1-e1", band: "EASY", stem: "A radius is drawn to a point of tangency. What is the angle between the radius and the tangent line?", choices: ["45°", "60°", "90°", "180°"], answerFormat: "MC" },
  ...
  G4U2: {
    ...
    problems: [
      ...
      { id: "g4u2-e2", band: "EASY", stem: "Which point lies on the circle (x − 2)² + (y − 3)² = 16?", choices: ["(2, 3)", "(6, 3)", "(6, 7)", "(0, 0)"], answerFormat: "MC" },
