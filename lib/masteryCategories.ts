...
export const masteryCategories: readonly MasteryCategory[] = [
  ...
  { id: "foundations-skills", name: "Foundations & Skills", shortName: "Foundations & Skills", strands: ["F", "S", "P", "X"], color: "#2f766d", description: "Number fluency, expressions, equation moves, graph reading, SAT strategy, grid-ins, and Desmos technique." },
] as const;
