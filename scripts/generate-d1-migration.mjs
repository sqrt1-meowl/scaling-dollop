...
import { allDrillUnits } from "../lib/curriculum.ts";
...
await writeFile(new URL("../drizzle/0006_simplified_unlocked_practice.sql", import.meta.url), `${statements.join(";\n")};\n`, "utf8");
console.log(`Generated the simplified unlocked-practice schema migration for ${allDrillUnits.length} units. Expanded demo questions remain application seed data.`);
